...
// Controls
const controls = new PointerLockControls(camera0,renderer.domElement );
...
//Used for rotating the human model
//Directions for keyboard buttons:w=1,a=2,s=3,d=4
...
const onKeyDown=(event)=>
{
    ...
    {
        case "KeyW":
            glthuman.scene.position.x-=0.5
           controls.moveForward(0.5)
           action0.play()
           if(dir==2)
           {
            glthuman.scene.rotation.y=-Math.PI*0.5
           }
           else if(dir==3)
           {
            glthuman.scene.rotation.y=-Math.PI*0.5
        ...
        case "KeyS":
           ...
           dir=3
            break  
        case "KeyA":
            glthuman.scene.position.z+=0.5
            controls.moveRight(-0.5) 
            action0.play()
            if(dir==1)
           {
            glthuman.scene.rotation.y=Math.PI*0.125
           }
           else if(dir==3)
           {
            glthuman.scene.rotation.y=Math.PI*0.125
           ...
           {
            glthuman.scene.rotation.y=Math.PI*2
           }
           dir=2
            break 
        case "KeyD":
            ...
            if(dir==1)
            {
             glthuman.scene.rotation.y=(-Math.PI)
            }
            else if(dir==2)
            {
             glthuman.scene.rotation.y=-Math.PI
            ...
            {
             glthuman.scene.rotation.y=Math.PI-(Math.PI*0.125)
            } 
            dir=4
            break
        case "KeyO":
            glthuman.scene.rotation.y+=0.25
            break           
    }
}
const keyup=()=>
...
//mobiles and touchscreen button controls
...
const controlsgui={
    OrbitControlsGui:()=>
    {
        ...
        orbitcontrols=new OrbitControls(camera0,renderer.domElement)
    ...
    FPP:()=>
    {
        ...
        controls.enabled=true
        if(glthuman!=null)
        {scene.remove(glthuman.scene)}
        camera0.position.set(40,5,0)
    }
}
 

//Add folders to gui
const guicontrolsbuttons=gui.addFolder("Controls Switching")
guicontrolsbuttons.add(controlsgui,'OrbitControlsGui')
guicontrolsbuttons.add(controlsgui,'TPP')
guicontrolsbuttons.add(controlsgui,'FPP')
guicontrolsbuttons.open()
...
function updatePlayer(){
  ...
  controls1.target.copy(mesh.position)
  camera0.position.add(mesh.position)
}  
...
**
*/
const valfly=controls.enabled
if(valfly==true)
    {    
        controls.enableRotate=false
        controls.noPan=false
        document.querySelector("button#w").style.visibility="visible"
        document.querySelector("button#a").style.visibility="visible"
        document.querySelector("button#s").style.visibility="visible"
        document.querySelector("button#d").style.visibility="visible"
        document.addEventListener('keydown', onKeyDown)
        document.addEventListener('keyup', keyup)
    }
if(orbitcontrols!=null)
{
    const valorbit=orbitcontrols.enabled
    if(valorbit==true)
    {
        controls.enabled=false
        document.querySelector("button#w").style.visibility="hidden"
        document.querySelector("button#a").style.visibility="hidden"
        document.querySelector("button#s").style.visibility="hidden"
        document.querySelector("button#d").style.visibility="hidden"
